    ...
    <aside class="col-12 col-md-12 col-lg-2">
      <div class="sidebar box sticky-column is_stuck">
        <ul class="nav">
          ...
          <li class="nav__item"><NavLink exact to="/contact"><i class="fas fa-book"></i>Blog</NavLink></li>
          <li class="nav__item"><NavLink exact to="/blog"><i class="fas fa-phone"></i>Contact</NavLink></li>
        </ul>
      </div>
    </aside>
  )
