...
const About = () => {
  return (
    <div className="col-12 col-md-12 col-lg-10" id="about" >
      <div className="box box-content">
        ...
        <div className="mt-1">
          ...
          <div className="row">
            {/* <!-- Case Item --> */}
            <div className="col-case-item col-padding">
            ...
            <div className="col-case-item col-padding">
              <div className="case-item">
                <img className="case-item__icon" src={iconapp} alt="" />
                <div>
            ...
            <div className="col-case-item col-padding">
              <div className="case-item">
                <img className="case-item__icon" src={iconphoto} alt="" />
                <div>
